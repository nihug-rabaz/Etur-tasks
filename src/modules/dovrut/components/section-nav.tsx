        ...
        {ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {open ? (
                <div className="absolute top-[calc(100%+0.4rem)] z-30 min-w-[14rem] rounded-2xl border border-black/8 bg-white p-2 shadow-xl dark:border-white/10 dark:bg-[#161922]">
                  {rows.length === 0 ? (
