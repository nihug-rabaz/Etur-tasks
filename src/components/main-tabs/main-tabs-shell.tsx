...
export function MainTabsShell({ tabs: initialTabs }: MainTabsShellProps) {
  ...
  return (
    <section className="relative isolate flex min-h-full flex-1 flex-col">
      ...
      <div className="relative z-10 mx-auto flex h-[calc(100dvh-7.25rem)] max-h-[calc(100dvh-7.25rem)] min-h-0 w-[96%] max-w-[2200px] flex-col gap-4 pb-4 pt-3 sm:gap-5 sm:pb-5 sm:pt-5">
