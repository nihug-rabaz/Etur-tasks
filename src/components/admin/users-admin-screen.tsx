...
export async function UsersAdminScreen() {
  ...
  const moduleRolesByUser = await moduleRoleService.getRolesByUserIds(users.map((user) => user.id));
  ...
  return (
    <section className="pb-8">
      <UsersManagementPanel
        ...
        moduleRolesByUser={moduleRolesByUser as Record<string, Record<string, ModuleRole>>}
        updateRoleAction={updateUserRoleAction}
        syncPermissionsAction={syncUserPermissionsAction}
        setModuleRoleAction={setUserModuleRoleAction}
