  ...
  return (
    <section className="mx-auto w-full max-w-2xl space-y-6">
      <div className="rounded-3xl border border-border-weak bg-gradient-to-l from-surface-1 via-surface-1 to-surface-2/80 p-6">
        <h1 className="text-3xl font-bold tracking-tight text-text-primary">הגדרות אישיות</h1>
        <p className="mt-2 text-sm text-text-secondary">התאמת התצוגה, שם המשתמש ותמונת הפרופיל שלך.</p>
      </div>
