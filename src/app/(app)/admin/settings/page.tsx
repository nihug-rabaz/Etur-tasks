import { AssistantReleasePanel } from "@/components/admin/assistant-release-panel";
    ...
    <section className="space-y-5 pb-8">
      <div className="dashboard-glass rounded-3xl p-5 sm:p-6">
        ...
        <p className="mt-1 text-sm text-text-secondary">
          התאמת אייקונים ותמונות לטאבים במסך הראשי, בדיקת התראות דפדפן, ושחרור העוזר.
        </p>
      </div>
      <AssistantReleasePanel />
      <OneSignalTestPanel />
